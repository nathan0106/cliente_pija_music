...
@Component({
  selector: 'app-dashboardmusicacomponent',
  templateUrl: './dashboard-musica.component.html',
  styleUrls: ['./dashboard-musica.component.css'], 
  imports: [
    MatCardModule,
    MatButtonModule,
    MatSidenavModule,
...
export class DashboardMusicaComponent { 
